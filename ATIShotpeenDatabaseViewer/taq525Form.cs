...
namespace ATICertViewer
{
    public partial class TAQ525Form : Form
    {
        ...
        public TAQ525Form(bool _canEdit, string _userName)
        {
            InitializeComponent();
        ...
        public TAQ525Form(string ID_num, bool _canEdit, string _userName)
        {
            InitializeComponent();
        ...
        private void SubmitNewRow()
        {
            ...
            using (OdbcConnection conn = new OdbcConnection(connectionString))
            {
                ...
                // specify query
                string query = "INSERT INTO ATIDelivery.dbo.MagTaq525ProcessControlLog\n" +
                                "([ID]\n" +
                                ",[Date]\n" +
                                ",[Internal Shorts]\n" +
        ...
        private void UpdateRow()
        {
            ...
            using (OdbcConnection conn = new OdbcConnection(connectionString))
            {
                ...
                // specify query
                string query = "UPDATE ATIDelivery.dbo.MagTaq525ProcessControlLog\n" +
